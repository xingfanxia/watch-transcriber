...
- **Markdown attachments**: paste or pick a `.md`/`.txt` in the detail pane's 附注 section — stored as `data/<date>/<HHMMSS>-attachments/*.md`, listed in the manifest, rendered in-app (vendored `marked`), and pushed to the private repo like everything else.
